...
namespace NoiseUtils
{
	...
	{
		Value, Perlin, SimplexValue, Simplex
	}
	...
	public static class Noise
	{
		...
		{
			SimplexValue1D, SimplexValue2D, SimplexValue3D
		};

		public static NoiseMethod[] simplexMethods =
		{
			Simplex1D, Simplex2D, Simplex3D
		};
		...
		{
			// 6t^5 - 15t^4 + 10t^3 (5th degree polynomial smoothing.
